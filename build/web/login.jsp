...
<html lang="en">
    ...
    <body>
        <div class="logo" style="margin-top: 5% ">    
            <a style="font-size: 55px; font-family: 'Lobster', cursive; text-decoration: none; color: black" href="home">ShopHuynon</a>
        </div>
        <div class="container">
            <form action="login" method="post">
                <div class="row">
                    <h2 style="text-align:center">Đăng nhập hoặc không đăng nhập</h2>
                    <div class="col">
                        <p>${mess}</p>
