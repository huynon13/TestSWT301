...
public class ShopAllControl extends HttpServlet {
    ...
    List<Product> list;
    if ("asc".equals(sort)) {
        list = dao.getProductsSortedByPrice("asc");
    } else if ("desc".equals(sort)) {
        list = dao.getProductsSortedByPrice("desc");
    } else {
        list = paginDao.pagingAllProduct(index);  // Mặc định không sắp xếp
    }
